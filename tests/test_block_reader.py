...
def check_round_trip(write_to_disk):
    ...
    check_block(
        blocks[1], 16016, 656, records[811 : 811 + 656], "null", 16272, 16037
    )
    check_block(
        blocks[2], 13677, 533, records[811 + 656 :], "null", 32309, 13698
    )
...
def check_round_trip_deflated(write_to_disk):
    ...
    check_block(
        blocks[1], 16016, 656, records[811 : 811 + 656], "deflate", 6492, 5624
    )
    check_block(
        blocks[2], 13677, 533, records[811 + 656 :], "deflate", 12116, 4427
    )
