...
def test_validate_null_in_string_raises():
    records = [{"str_null": "str", "str": None, "integ_null": 21, "integ": 21}]
...
def test_validate_unicode_in_string_does_not_raise():
    ...
    records = [{"str_null": non_ascii, "str": "str", "integ_null": 21, "integ": 21}]

    validation_raise(schema, *records)

    records = [{"str_null": "str", "str": "str", "integ_null": 21, "integ": non_ascii}]
...
def test_validate_array():
    my_schema = {
        "fields": [{"name": "array", "type": {"type": "array", "items": "string"}}],
        "namespace": "namespace",
...
def test_validate_map():
    my_schema = {
        "fields": [{"name": "map", "type": {"type": "map", "values": "string"}}],
        "namespace": "namespace",
